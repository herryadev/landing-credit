...
export default function DaoHanHero() {
  return (
    <section className="relative min-h-[600px] flex items-center justify-center overflow-hidden pt-24 pb-20">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            Dịch vụ đáo hạn thẻ tín dụng nhanh chóng, an toàn, 
            chi phí thấp chỉ từ <span className="font-bold text-orange-400">1.3%</span>
          </motion.p>
